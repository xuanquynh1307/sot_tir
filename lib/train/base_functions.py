...
# datasets related
from lib.train.dataset import LSOTB
...
def names2datasets(name_list: list, settings, image_loader):
    ...
    for name in name_list:
        assert name in ["LSOTB_train", "LSOTB_val"]
        if name == "LSOTB_train":
            datasets.append(LSOTB(settings.env.lsotb_dir, split='train', image_loader=image_loader))
        if name == "LSOTB_val":
            datasets.append(LSOTB(settings.env.lsotb_dir, split='val', image_loader=image_loader))
