...
def generate_heatmap(single_patch_bboxes, patch_size=320, stride=16):
    """
    Generate ground truth heatmap same as CenterNet
    Args:
        bbox (torch.Tensor): shape of [num_search, bs, 4], num_search is only 1 image

    Returns:
        gaussian_maps: generated heatmap
