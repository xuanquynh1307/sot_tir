...
"""
Add default config for proposed method
"""
cfg = edict()
...
cfg.DATA.MEAN = [0.358, 0.358, 0.358]
cfg.DATA.STD = [0.132, 0.132, 0.132]
cfg.DATA.MAX_SAMPLE_INTERVAL = 200
# DATA.TRAIN
cfg.DATA.TRAIN = edict()
cfg.DATA.TRAIN.DATASETS_NAME = ["LSOTB_train"]
cfg.DATA.TRAIN.DATASETS_RATIO = [1]
cfg.DATA.TRAIN.SAMPLE_PER_EPOCH = 60000
# DATA.VAL
cfg.DATA.VAL = edict()
cfg.DATA.VAL.DATASETS_NAME = ["LSOTB_val"]
